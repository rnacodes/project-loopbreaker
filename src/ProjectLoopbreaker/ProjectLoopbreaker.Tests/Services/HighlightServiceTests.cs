...
namespace ProjectLoopbreaker.Tests.Services
{
    public class HighlightServiceTests
    {
        ...
        public HighlightServiceTests()
        {
            ...
            _mockContext.Setup(c => c.Articles).Returns(_mockArticleSet.Object);
            _mockContext.Setup(c => c.Books).Returns(_mockBookSet.Object);
        ...
        public async Task CreateHighlightAsync_ValidData_CreatesHighlight()
        {
            ...
            _mockHighlightSet.Setup(m => m.Add(It.IsAny<Highlight>()))
                .Callback<Highlight>(h => h.Id = Guid.NewGuid());
            ...
            // Assert
            result.Should().NotBeNull();
            result.HighlightText.Should().Be("New highlight");
            result.Note.Should().Be("Test note");
            _mockHighlightSet.Verify(m => m.Add(It.IsAny<Highlight>()), Times.Once);
