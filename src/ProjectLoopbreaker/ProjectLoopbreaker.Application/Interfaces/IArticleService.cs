...
namespace ProjectLoopbreaker.Application.Interfaces
{
    public interface IArticleService
    {
        ...
        Task<Article?> GetArticleByInstapaperIdAsync(string instapaperBookmarkId);
        
        // Instapaper sync operations
        Task<ArticleSyncResultDto> SyncArticlesFromInstapaperAsync();
        Task<Article> UpdateArticleSyncStatusAsync(Guid id, bool isArchived, bool isStarred, string? hash);
