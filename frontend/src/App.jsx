...
import { createTheme, ThemeProvider, CssBaseline, Container, Box, Typography, TextField, IconButton, Grid, Card, CardMedia, CardContent, Button, SpeedDial, SpeedDialIcon, SpeedDialAction } from '@mui/material';
import { 
    ...
    PlaylistAdd // <<< CORRECTED ICON NAME
...
const theme = createTheme({
  palette: {
    mode: 'dark', // Ensures proper dark mode behavior for components
    primary: {
      main: '#695a8c', // ultra-violet
    },
    secondary: {
      main: '#fcfafaff', // seasalt (used for buttons to contrast with dark bg)
    },
    background: {
      default: '#300a70', // persian-indigo
      paper: '#474350', // davys-gray
    },
    text: {
      primary: '#fcfafaff', // seasalt
      secondary: '#b0aebc',
    },
  },
  typography: {
    ...
    h1: {
      fontSize: '3.5rem',
      fontWeight: 700,
      color: '#fcfafaff', // seasalt (inverted for dark bg)
      textAlign: 'center',
      marginBottom: '1rem',
    },
    h4: {
...
// 2. MOCK DATA
// Alphabetically sorted list of main media icons
...
// Larger, featured icons for their own row
          ...
          <Box sx={{ textAlign: 'center', my: 6 }}>
              <Button 
                  ...
                  sx={{ 
                      ...
                      mb: 4, 
                      minWidth: '300px',
                      color: theme.palette.background.default, // persian-indigo text on light button
                      backgroundColor: theme.palette.text.primary // seasalt background
                  }}
              >
                  I'm Feeling Lucky
              </Button>
